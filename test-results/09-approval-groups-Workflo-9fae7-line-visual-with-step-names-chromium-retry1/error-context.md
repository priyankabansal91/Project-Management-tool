...
- Name: 09-approval-groups.spec.ts >> Workflow Steps Configuration >> Shows pipeline visual with step names
- Location: e2e\09-approval-groups.spec.ts:121:7
...
Error: strict mode violation: getByText('Core Team Review') resolved to 2 elements:
    1) <div class="font-semibold text-gray-800 text-xs">1. Core Team Review</div> aka getByText('1. Core Team Review')
    2) <td class="px-4 py-3 font-medium text-gray-800">Core Team Review</td> aka getByRole('cell', { name: 'Core Team Review' })
    ...
    - main [ref=e361]:
      - generic [ref=e363]:
        ...
        - generic [ref=e393]:
          ...
          - button "Workflow Steps" [active] [ref=e400] [cursor=pointer]:
            - img [ref=e401]
            - text: Workflow Steps
        ...
        - generic [ref=e409]:
          - generic [ref=e410]:
            ...
            - button "Add Step" [ref=e412] [cursor=pointer]:
              - img [ref=e413]
              - text: Add Step
          - generic [ref=e414]:
