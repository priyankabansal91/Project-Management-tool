...
- Name: 08-preproject-workflow.spec.ts >> Workflow Training Guide >> shows all role selector cards
- Location: e2e\08-preproject-workflow.spec.ts:368:7
...
Locator: getByText('Project Manager')
Expected: visible
Error: strict mode violation: getByText('Project Manager') resolved to 2 elements:
    1) <p class="text-xs font-semibold">Project Manager</p> aka getByRole('button', { name: 'Project Manager Initiates the' })
    2) <h3 class="tracking-tight text-sm font-semibold">Step-by-Step Guide — Project Manager</h3> aka getByRole('heading', { name: 'Step-by-Step Guide — Project' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Project Manager')
