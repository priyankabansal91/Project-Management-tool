...
- Name: 08-preproject-workflow.spec.ts >> Pre-Project Form (multi-step) >> fills step 1 and proceeds to step 2
- Location: e2e\08-preproject-workflow.spec.ts:90:7
      ...
      - generic [ref=e363]:
        ...
        - generic [ref=e396]:
          - generic [ref=e397]:
            ...
            - textbox "e.g. TDR/2026/HWY/004" [ref=e399]: TDR/2026/TEST/001
          ...
          - generic [ref=e404]:
            ...
            - textbox "e.g. NH-46 Highway Widening Phase III" [active] [ref=e406]: Test Project Title
          - generic [ref=e407]:
...
```ts
  ...
  4   | // ── Pre-Project List ──────────────────────────────────────────────────────────
  5   | 
  6   | test.describe('Pre-Project List', () => {
  7   |   test('loads without crash and shows stat cards', async ({ page }) => {
  8   |     await injectDevAuth(page);
  9   |     await page.goto('/preproject');
  10  |     await page.waitForLoadState('networkidle');
  11  |     await expect(page.locator('body')).not.toContainText('TypeError');
  12  |     await expect(page.locator('body')).not.toContainText('Cannot read properties');
