...
- Name: 09-approval-groups.spec.ts >> Approval Group Configuration >> Approval type selector visible in modal
- Location: e2e\09-approval-groups.spec.ts:53:7
...
Locator: getByText('ANY')
Expected: visible
Error: strict mode violation: getByText('ANY') resolved to 5 elements:
    1) <div class="text-xs text-gray-400 mt-1">ANY · ALL · QUORUM</div> aka getByText('ANY · ALL · QUORUM')
    2) <span class="px-2 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-700">ANY</span> aka locator('span').filter({ hasText: 'ANY' })
    3) <p class="text-xs text-gray-500 mt-0.5">Financial sanction — any one CFO-level executive …</p> aka getByText('Financial sanction — any one')
    4) <div class="font-bold">ANY</div> aka getByRole('button', { name: 'ANY Any 1 member' })
    5) <div class="text-xs font-normal text-gray-500 mt-0.5">Any 1 member</div> aka getByRole('button', { name: 'ANY Any 1 member' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('ANY')
      ...
      - generic [ref=e363]:
        ...
        - generic [ref=e409]:
          - generic [ref=e410]:
            ...
            - button "New Group" [active] [ref=e412] [cursor=pointer]:
              - img [ref=e413]
              - text: New Group
          - generic [ref=e414]:
            - generic [ref=e415]:
            ...
            - generic [ref=e555]:
              ...
              - generic [ref=e562]:
                ...
                - generic [ref=e564]:
                  ...
                  - button "QUORUM Configurable count" [ref=e571] [cursor=pointer]:
                    - generic [ref=e572]: QUORUM
                    - generic [ref=e573]: Configurable count
              - generic [ref=e574]:
                - generic [ref=e575]: SLA Hours (decision deadline)
                - generic [ref=e576]:
                  - spinbutton [ref=e577]: "48"
                  - generic [ref=e578]: hours
            - generic [ref=e579]:
              - button "Cancel" [ref=e580] [cursor=pointer]
              - button "Save Group" [disabled] [ref=e581]:
                - img [ref=e582]
                - text: Save Group
```
